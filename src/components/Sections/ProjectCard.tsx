...
export const ProjectCard: React.FC<ProjectCardProps> = ({ title, problem, techStack, status, onClick }) => {
    return (
        <Card
            className="h-full flex flex-col hover:border-blue-500 dark:hover:border-cyan-500 group relative"
            onClick={onClick}
        >
